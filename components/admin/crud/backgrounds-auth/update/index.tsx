...
const BackgroundsAuthUpdate = () => {
  const [backgrounds, setBackgrounds] = useState<BackgroundsAuth>({
    id: '',
    url: '',
    order: 0,
  });
  ...
  const handleUpdate = async (e: FormEvent) => {
    ...
    try {
      await backgrounds_auth_service.update(Number(backgrounds.id), {
        url: backgrounds.url,
...
export default BackgroundsAuthUpdate;
